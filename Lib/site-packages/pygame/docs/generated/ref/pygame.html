...
<html lang="en">
  <head>
    ...
    <title>pygame &#8212; pygame v2.1.4 documentation</title>
...
<tbody>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.IS_CE">pygame.IS_CE</a></div>
</td>
<td>—</td>
<td>exists if current pygame is pygame-ce</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.init">pygame.init</a></div>
</td>
<td>—</td>
<td>initialize all imported pygame modules</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.quit">pygame.quit</a></div>
</td>
<td>—</td>
<td>uninitialize all pygame modules</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.get_init">pygame.get_init</a></div>
</td>
<td>—</td>
<td>returns True if pygame is currently initialized</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.error">pygame.error</a></div>
</td>
<td>—</td>
<td>standard pygame exception</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.get_error">pygame.get_error</a></div>
</td>
<td>—</td>
<td>get the current error message</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.set_error">pygame.set_error</a></div>
</td>
<td>—</td>
<td>set the current error message</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.get_sdl_version">pygame.get_sdl_version</a></div>
</td>
<td>—</td>
<td>get the version number of SDL</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.get_sdl_byteorder">pygame.get_sdl_byteorder</a></div>
</td>
<td>—</td>
<td>get the byte order of SDL</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.register_quit">pygame.register_quit</a></div>
</td>
<td>—</td>
<td>register a function to be called when pygame quits</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.encode_string">pygame.encode_string</a></div>
</td>
<td>—</td>
<td>Encode a Unicode or bytes object</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.encode_file_path">pygame.encode_file_path</a></div>
</td>
<td>—</td>
<td>Encode a Unicode or bytes object as a file system path</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="pygame.html#pygame.print_debug_info">pygame.print_debug_info</a></div>
</td>
<td>—</td>
<td>retrieves useful information for debugging and issue-reporting purposes</td>
</tr>
</tbody>
</table>
...
<dt class="sig sig-object py title" id="pygame.IS_CE">
<span class="sig-prename descclassname"><span class="pre">pygame.</span></span><span class="sig-name descname"><span class="pre">IS_CE</span></span><a class="headerlink" href="#pygame.IS_CE" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">exists if current pygame is pygame-ce</span></div>
<div class="line"><span class="signature">IS_CE = 1</span></div>
</div>
<p>Use <code class="docutils literal notranslate"><span class="pre">getattr(pygame,</span> <span class="pre">&quot;IS_CE&quot;,</span> <span class="pre">False)</span></code> to check if current pygame is pygame-ce</p>
</dd></dl>
...
<p><span class="versionmodified changed">Changed in pygame 2.1.4: </span><code class="docutils literal notranslate"><span class="pre">linked</span></code> keyword argument added</p>
</div>
</dd></dl>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.print_debug_info">
<span class="sig-prename descclassname"><span class="pre">pygame.</span></span><span class="sig-name descname"><span class="pre">print_debug_info</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.print_debug_info" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">retrieves useful information for debugging and issue-reporting purposes</span></div>
<div class="line"><span class="signature">print_debug_info(filename=None) -&gt; None</span></div>
</div>
<p>Constructs a string containing details on the system, the python interpreter,
the pygame version, and the linked and compiled versions of the libraries that
pygame wraps. If <code class="docutils literal notranslate"><span class="pre">filename</span></code> is <code class="docutils literal notranslate"><span class="pre">None</span></code>, then the string is printed into the
console. Otherwise, the debug string is written to the specified file.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If <code class="docutils literal notranslate"><span class="pre">pygame.freetype</span></code> has not been initialized with <a class="tooltip reference internal" href="#pygame.init" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.init()</span></code><span class="tooltip-content">initialize all imported pygame modules</span></a> or <a class="tooltip reference internal" href="freetype.html#pygame.freetype.init" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.freetype.init()</span></code><span class="tooltip-content">Initialize the underlying FreeType library.</span></a>,
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/ref\pygame.rst" rel="nofollow">Edit on GitHub</a>
