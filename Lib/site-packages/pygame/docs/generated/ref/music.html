...
<html lang="en">
  <head>
    ...
    <title>pygame.mixer.music &#8212; pygame v2.1.4 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="music.html#pygame.mixer.music.get_metadata">pygame.mixer.music.get_metadata</a></div>
</td>
<td>—</td>
<td>get metadata of the specified or currently loaded music stream</td>
</tr>
</tbody>
</table>
...
<dl class="py function definition">
<dt class="sig sig-object py title" id="pygame.mixer.music.get_metadata">
<span class="sig-prename descclassname"><span class="pre">pygame.mixer.music.</span></span><span class="sig-name descname"><span class="pre">get_metadata</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.mixer.music.get_metadata" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">get metadata of the specified or currently loaded music stream</span></div>
<div class="line"><span class="signature">get_metadata() -&gt; dict</span></div>
<div class="line"><span class="signature">get_metadata(filename) -&gt; dict</span></div>
<div class="line"><span class="signature">get_metadata(fileobj, namehint=&quot;&quot;) -&gt; dict</span></div>
</div>
<p>If no arguments are passed returns a dictionary containing metadata
of the currently loaded music stream, raises an exception if a music stream is not loaded.
Available keys are <code class="docutils literal notranslate"><span class="pre">&quot;title&quot;</span></code>, <code class="docutils literal notranslate"><span class="pre">&quot;album&quot;</span></code>, <code class="docutils literal notranslate"><span class="pre">&quot;artist&quot;</span></code>, <code class="docutils literal notranslate"><span class="pre">&quot;copyright&quot;</span></code>.
...
Here is an example:
<code class="docutils literal notranslate"><span class="pre">{'title':</span> <span class="pre">'Small</span> <span class="pre">Tone',</span> <span class="pre">'album':</span> <span class="pre">'Tones',</span> <span class="pre">'artist':</span> <span class="pre">'Audacity</span> <span class="pre">Generator',</span> <span class="pre">'copyright':</span> <span class="pre">''}</span></code></p>
<p>Refer to the <a class="tooltip reference internal" href="#pygame.mixer.music.load" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.mixer.music.load()</span></code><span class="tooltip-content">Load a music file for playback</span></a> function for arguments regarding specifying a file or a file-like object
whose metadata you want to retrieve. For this function all arguments are optional,
however, specifying only the <code class="docutils literal notranslate"><span class="pre">namehint</span></code> will raise an exception.</p>
<p>Since the underlying functionality was introduced in version 2.6.0 of SDL_mixer,
...
by using <a class="tooltip reference internal" href="mixer.html#pygame.mixer.get_sdl_mixer_version" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.mixer.get_sdl_mixer_version()</span></code><span class="tooltip-content">get the mixer's SDL version</span></a>.</p>
<div class="versionadded">
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/ref\music.rst" rel="nofollow">Edit on GitHub</a>
