...
<html lang="en">
  <head>
    ...
    <title>pygame.image &#8212; pygame v2.1.4 documentation</title>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame 2.1.4: </span><code class="docutils literal notranslate"><span class="pre">linked</span></code> keyword argument added and default behavior changed from returning compiled version to returning linked version</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">fromstring(bytes, size, format, flipped=False, pitch=-1) -&gt; Surface</span></div>
</div>
...
<p>The 'pitch' argument can be used specify the pitch/stride per horizontal line
...
extra padding. By default, it is <code class="docutils literal notranslate"><span class="pre">-1</span></code>, which means that the pitch/stride is
the same size as how many bytes the pure pixel data of each horizontal line takes.</p>
...
<div class="versionadded">
<p><span class="versionmodified added">New in pygame 2.1.4: </span>Added a 'pitch' argument and support for keyword arguments.</p>
</div>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">create new Surface from a byte buffer</span></div>
<div class="line"><span class="signature">frombytes(bytes, size, format, flipped=False, pitch=-1) -&gt; Surface</span></div>
</div>
...
<div class="line"><span class="signature">frombuffer(buffer, size, format, pitch=-1) -&gt; Surface</span></div>
</div>
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/ref\image.rst" rel="nofollow">Edit on GitHub</a>
