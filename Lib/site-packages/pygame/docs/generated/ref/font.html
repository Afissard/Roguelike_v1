...
<html lang="en">
  <head>
    ...
    <title>pygame.font &#8212; pygame v2.1.4 documentation</title>
...
<div class="line"><span class="signature">Font(filename=None, size=20) -&gt; Font</span></div>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.align">pygame.font.Font.align</a></div>
</td>
<td>—</td>
<td>Set how rendered text is aligned when given a wrap length</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.render">pygame.font.Font.render</a></div>
</td>
<td>—</td>
<td>draw text on a new Surface</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.size">pygame.font.Font.size</a></div>
</td>
<td>—</td>
<td>determine the amount of space needed to render text</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_underline">pygame.font.Font.set_underline</a></div>
</td>
<td>—</td>
<td>control if text is rendered with an underline</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_underline">pygame.font.Font.get_underline</a></div>
</td>
<td>—</td>
<td>check if text will be rendered with an underline</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_strikethrough">pygame.font.Font.set_strikethrough</a></div>
</td>
<td>—</td>
<td>control if text is rendered with a strikethrough</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_strikethrough">pygame.font.Font.get_strikethrough</a></div>
</td>
<td>—</td>
<td>check if text will be rendered with a strikethrough</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_bold">pygame.font.Font.set_bold</a></div>
</td>
<td>—</td>
<td>enable fake rendering of bold text</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_bold">pygame.font.Font.get_bold</a></div>
</td>
<td>—</td>
<td>check if text will be rendered bold</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_italic">pygame.font.Font.set_italic</a></div>
</td>
<td>—</td>
<td>enable fake rendering of italic text</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.metrics">pygame.font.Font.metrics</a></div>
</td>
<td>—</td>
<td>gets the metrics for each character in the passed string</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_italic">pygame.font.Font.get_italic</a></div>
</td>
<td>—</td>
<td>check if the text will be rendered italic</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_linesize">pygame.font.Font.get_linesize</a></div>
</td>
<td>—</td>
<td>get the line space of the font text</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_height">pygame.font.Font.get_height</a></div>
</td>
<td>—</td>
<td>get the height of the font</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_ascent">pygame.font.Font.get_ascent</a></div>
</td>
<td>—</td>
<td>get the ascent of the font</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.get_descent">pygame.font.Font.get_descent</a></div>
</td>
<td>—</td>
<td>get the descent of the font</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_script">pygame.font.Font.set_script</a></div>
</td>
<td>—</td>
<td>set the script code for text shaping</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="font.html#pygame.font.Font.set_direction">pygame.font.Font.set_direction</a></div>
</td>
<td>—</td>
<td>set the script direction for text shaping</td>
</tr>
</tbody>
</table>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame 2.1.4: </span>If no arguments are given then the default font will be used and
a font size of 20 is used.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame 2.1.4: </span>This class is also available through the <code class="docutils literal notranslate"><span class="pre">pygame.Font</span></code>
alias.</p>
</div>
...
<dl class="py attribute definition">
<dt class="sig sig-object py title" id="pygame.font.Font.align">
<span class="sig-name descname"><span class="pre">align</span></span><a class="headerlink" href="#pygame.font.Font.align" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Set how rendered text is aligned when given a wrap length</span></div>
<div class="line"><span class="signature">align -&gt; int</span></div>
</div>
<p>Can be set to <cite>pygame.FONT_LEFT</cite>, <cite>pygame.FONT_RIGHT</cite>, or
<cite>pygame.FONT_CENTER</cite>. This controls the text alignment behavior for the
font.</p>
<p>Requires pygame built with SDL_ttf 2.20.0, as all official pygame
distributions are.</p>
<div class="versionadded">
...
<div class="line"><span class="signature">render(text, antialias, color, background=None, wraplength=0) -&gt; Surface</span></div>
</div>
...
<p>Null characters ('x00') raise a TypeError. Both Unicode and char (byte)
...
<p>The <cite>wraplength</cite> argument describes the width (in pixels) a line of text
should be before wrapping to a new line. See
<a class="tooltip reference internal" href="#pygame.font.Font.align" title=""><code class="xref py py-attr docutils literal notranslate"><span class="pre">pygame.font.Font.align</span></code><span class="tooltip-content">Set how rendered text is aligned when given a wrap length</span></a> for line-alignment settings.</p>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame 2.1.4: </span>newline characters now will break text into
multiple lines.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame 2.1.4: </span>wraplength parameter</p>
</div>
</dd></dl>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.font.Font.set_direction">
<span class="sig-name descname"><span class="pre">set_direction</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.font.Font.set_direction" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">set the script direction for text shaping</span></div>
<div class="line"><span class="signature">set_direction(direction=int) -&gt; None</span></div>
</div>
<p>Sets the font direction for harfbuzz text rendering, taking in an integer
between 0 and 3 (inclusive) as input. There are convenient constants defined
for use in this method.</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">pygame.DIRECTION_LTR</span></code> is for left-to-right text</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">pygame.DIRECTION_RTL</span></code> is for right-to-left text</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">pygame.DIRECTION_TTB</span></code> is for top-to-bottom text</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">pygame.DIRECTION_BTT</span></code> is for bottom-to-top text</p></li>
</ul>
<p>This method requires pygame built with SDL_ttf 2.20.0 or above. Otherwise the
method will raise a pygame.error.</p>
<div class="versionadded">
...
<br /><br />
<hr />
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/ref\font.rst" rel="nofollow">Edit on GitHub</a>
